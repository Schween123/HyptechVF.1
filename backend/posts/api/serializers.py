...
from ..models import Owner, BoardingHouse, Room, Tenant, Guardian, AddOn, Transaction
...
class RoomSerializer(serializers.ModelSerializer):
    class Meta:
        model = Room
        fields = ['id', 'room_number', 'capacity', 'boarding_house']
    ...
    class Meta:
        ...
        fields = ['id', 'boarderfirstname', 'boardermiddlename', 'boarderlastname', 'boardergender', 
                  ...
                  'boardercontactnumber', 'assigned_room', 'monthly_rent', 'total_monthly_due',
                    'due_date', 'initial_payment', 'add_ons','payment_status']
