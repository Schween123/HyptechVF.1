...
const ReportSummary = () => {
  ...
  const generateMonths = () => {
    ...
    while (date <= currentDate) {
      ...
      console.log("Adding month:", monthNames[date.getMonth()], year);
    }

    console.log("Generated months:", monthsList);
    return monthsList;
  };
        ...
        <div className="max-w-screen-xl mx-auto p-8">
          ...
          <div className="overflow-x-auto">
            <table>
              <thead>
                <tr>
                  <th className="bg-customcyan text-white !font-montserrat">
                    Name
                  </th>
                  {months.map((monthObj, index) => (
                    <th
                      key={index}
                      className="bg-customcyan text-white !font-montserrat"
                    >
